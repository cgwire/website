# Your Artists Are Artists. Not Project Managers.

*And with Kitsu, they never have to be.*
...
It's a fair concern. Most production tools are built for producers—and then handed to artists who just want to draw, rig, animate, and render.

Kitsu was designed differently. **Each role gets exactly what they need—nothing more, nothing less.**
...
<!-- WALKTHROUGH GIF: Artist opening a task → viewing reference → uploading a preview → task marked "In Review" — 15–20 seconds -->
...
<!-- WALKTHROUGH GIF: Producer dashboard — schedule view → production report → quota tracking — 20–25 seconds -->
...
1. They receive an invitation link
2. They log in and see their task list
3. They click a task, review their brief, upload their first version
...
<!-- WALKTHROUGH GIF: Producer setting up a new project from a template → inviting team → first tasks appearing in artists' to-do lists — 25–30 seconds -->
...
<!-- SCREENSHOT or GIF: Clean task view, annotation tools on a preview, side-by-side version comparison -->
...
> *"We were worried our artists would push back. Within a week, they were uploading previews and checking off tasks without us even asking."*
> — Production Manager, mid-sized 2D animation studio
...
Start with a free cloud trial or deploy the open-source version—no commitment, no credit card required.
