# Why Not Just Keep Using Spreadsheets, Notion, or ShotGrid?

*We get it. The tool you have is the one you know. But "good enough" has a price — and in production, you're usually paying it in overtime, missed deliveries, and burnout.*
...
Spreadsheets are excellent at what they were designed for — static data, financial tables, simple lists. They are not designed for:
...
What you end up with is a documentation layer that describes the production but doesn't *run* it. You still need another system — or five — to fill the gaps.

---

### ShotGrid: Powerful, But at What Cost?

ShotGrid (formerly Shotgun, now owned by Autodesk) is a legitimate production tool. We respect it. But it comes with real tradeoffs that studios consistently raise with us:
...
None of these show up as a line item. They show up as crunch, turnover, and blown budgets.
...
**Visibility:** Producers, directors, and clients get the view they need — dashboards, progress reports, playlists — without coordinators spending half their day assembling decks.
...
Migrating to Kitsu typically takes days, not months. The open-source version costs nothing to try. And because your data is exposed via a full REST and Python API, Kitsu integrates with whatever pipeline tools you already use — it doesn't replace your pipeline, it organizes it.

The studios that delay the switch don't do it because they think spreadsheets are better. They do it because switching feels risky. We've built Kitsu to make that risk as small as possible.

---

*Ready to see what production tracking actually looks like when it works? [Start a free trial →](#)*
