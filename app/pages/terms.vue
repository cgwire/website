<template>
  <section class="section content narrower">
    ...
    <p><a href="#introduction"> Introduction Terms </a></p>
    <p><a href="#account"> Account Terms </a></p>
    <p><a href="#api"> API Terms </a></p>
    <p>
      <a href="#payment"> Payment, Refunds, Upgrading and Downgrading Terms </a>
    </p>
    <p><a href="#cancellation"> Cancellation and Termination </a></p>
    <p>
      <a href="#modifications"> Modifications to the Service and Prices </a>
    </p>
    <p><a href="#copyright"> Copyright and Content Ownership </a></p>
    <p><a href="#privacy"> Privacy and security of your data </a></p>
    <p><a href="#general"> General conditions </a></p>

    <h2 class="subtitle">Introduction</h2>

    <p>
      By using the CGWire Hosting (“Service”) provided by CGWire (“Company”),
      you are agreeing to be bound by the following terms and conditions (“Terms
      of Service”). If you do not agree to these Terms of Service, do not use
      this Service. By accepting these Terms of Service below or by using the
      Service in any manner, you and the entity you represent (“Customer”) agree
      that you have read and agree to be bound by this agreement to the
    ...
    <h2 class="subtitle" id="account">Account Terms</h2>
    ...
    <ol>
      ...
      <li>
        You may create separate logins for other people according to your
        Service plan. Any separate login or person will be automatically bound
        to these Terms of Service and it is your responsibility to inform your
        users about these Terms of Service.
      </li>
      <li>
        You must be a human. Accounts registered by “bots” or other automated
        methods are not permitted if they are used for other purpose than
        plugging your production pipeline.
      </li>
    </ol>

    <h2 class="subtitle" id="api">API Terms</h2>
    ...
    <h2 class="subtitle" id="payment">
      Payment, Refunds, Upgrading and Downgrading Terms
    </h2>

    <ol>
      <li>
        Customer is billed automatically via credit card via Stripe, or invoiced
        for payment, depending on the Service plan.
      </li>
      <li>
        The number of Seats purchased by Customer in the Service plan must be
        used during the applicable term and any unused Seats at the end of such
        term are forfeited. For a Service plan purchased for a yearly term, the
        Seats can be used anytime during the year.
      </li>
      <li>
        In the event the usage of Seats exceeds the Service plan you selected
        during a term, the Company will charge additional overage fees and the
        Customer shall be obligated to pay any overage fees in the next term.
        The overage fees are displayed in your Account page in CGWire Account
        website and on the pricing page at www.cg-wire.com/pricing.
      </li>
      <li>
        Upgrade or downgrade in the Service plan level will result in the new
        rate being charged at the next billing cycle.
      </li>
      <li>
      ...
      <li>Fees paid hereunder are non-refundable.</li>
      <li>
        ...
        levies, or duties. Where required, The Company will collect those taxes
        on behalf of taxing authority and remit those taxes to taxing
        authorities.
      </li>
      <li>
        For monthly payment plans, the Service is billed in advance on a monthly
        ...
        months unused with an open account. In order to treat everyone equally,
        no exceptions will be made.
      </li>
      <li>
        When changing from a monthly billing cycle to a yearly billing cycle,
        CGWire will bill for a full year at the next monthly billing date.
      </li>
      <li>
        In the event Customer utilizes a third party system as part of its
        utilization of the Service, the Company reserves the right to pass
        through its costs of such service to Customer, and Customer agrees to be
        pay such fees.
      </li>
    </ol>

    <h2 class="subtitle" id="cancellation">Cancellation and Termination</h2>

    <ol>
      <li>
        You are solely responsible for properly canceling your account. An email
        to cancel your account is not considered cancellation. You can cancel
        your account at any time by clicking on subscription section in Acount
        area of CGWire website. The Profile screen provides a simple
        no-questions-asked cancellation link.
      </li>
      <li>
        All of your content will be inaccessible from the Service immediately
        upon cancellation. Within 30 days, all CGWire content will be
        permanently deleted from all backups and logs. This information can not
      ...
      <li>
        ...
        cycle, and you will not be charged again. But there will not be any
        prorating of unused time in the last billing cycle.
      </li>
      <li>
    ...
    <ol>
      ...
      <li>
        ...
        the CGWire website at www.cg-wire.com or the Service itself.
      </li>
      <li>
    ...
    <h2 class="subtitle" id="copyright">
    ...
    <ol>
      ...
      <li>
        ...
        Application Services (“Feedback”). You agree that we own all rights to
        use and incorporate the Feedback you provide in any way, including in
        future enhancements and modifications to the Service, without payment or
        attribution to you.
      </li>
      <li>
        The look and feel of the Service is copyright© CGWire SAS All rights
      ...
      <li>
        “CGWire”, the CGWire logo, “Kitsu”, the Kitsu logo, and any other
        product or service name or slogan displayed on the Service are
        trademarks of the Company or its affiliates, and its licensors and may
    ...
    <h2 class="subtitle" id="privacy">Privacy and security of your data</h2>

    <ol>
      <li>
        When you use the Service to measure mobile and web properties, CGWire
        will collect information from your users. You consent to our use of
        users data to provide you with the Service.
      </li>
      <li>
      ...
      <li>
        You own all right, title, and interest to your users data. We obtain no
        rights from you to your users data.
      </li>
      <li>
      ...
      <li>
        You agree to not use the Service to send to the Company sensitive
        information where unauthorized disclosure could cause material, severe,
        or catastrophic harm or impact to the Company, any data subjects or
        third-parties. Sensitive Information includes, but is not limited to:
      </li>
      <li>Passwords, authentication/authorization credentials</li>
      <li>
        Information under regulatory or contractual handling requirements (e.g.,
        PCI, HIPAA, and state and federal data security laws) including, but not
        limited to:
      </li>
      <li>
        Credit card information, including credit card numbers, CIV numbers
        (three-digit codes for Visa and MasterCard, four-digit code for American
        Express) and magnetic stripe information
      </li>
      ...
      <li>
        Personally identifiable information knowingly collected from children
        under the age of 13 or from online services directed toward children,
        and
      </li>
      <li>Real-time geolocation data can identify an individual.</li>
      <li>
        Business secrets are deemed highly confidential (e.g., highly
        confidential business strategies and communications, sensitive
        attorney-client privileged and confidential communications).
      </li>
      <li>
        You agree that the Company may monitor the activity of any account on
        the Service. Any such data shall be only used for the purpose of
        providing and improving the Service.
      </li>
      <li>
        CGWire keeps confidential all employees information and production
        pictures and production information, such as names and entity
        descriptions, stored in the Service.
      </li>
    </ol>

    <h2 class="subtitle" id="general">General Conditions</h2>
    ...
    <ol>
      ...
      <li>
        Technical support is provided by email or Chat or Skype to paying
        Customers. Email responses are provided on the reasonable effort basis
        with a 48h response time. Chat is done through the Crisp application
        available in the Kitsu application or via the Discord service. Zoom call
        requires to set up an appointment via the Calendly service first.
      </li>
      <li>
        You understand that the Company may access your account, or information
        associated with your account, to provide support or maintenance, for
        security-related reasons, or any other business purpose.
      </li>
      <li>
      ...
      <li>
        ...
        determine in our sole discretion are unlawful or violate any party’s
        intellectual property or these Terms of Service.
      </li>
      <li>
        Verbal, physical, written or other abuse (including threats of abuse or
        retribution) of any Service customer, Company employee or officer may
      ...
      <li>
        This Agreement shall be governed by the laws of France, and the courts
        of France shall have exclusive jurisdiction to hear and determine all
      ...
      <li>
        ...
        errors in the Service will be corrected. Nevertheless due to the
        criticity of the production data, we'll do our best to keep the best
        uptime possilbe with a goal of 99.99%.
      </li>
      <li>
        You expressly understand and agree that the Company shall not be liable
      ...
      <li>
        ...
        provision. The Terms of Service constitute the entire agreement between
      ...
      <li>
        The Company reserves the right to update and change these Terms of
        Service without notice. Customers will be notified by email of any
        material change.
      </li>
      <li>
