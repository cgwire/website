          ...
          <li>
            <NuxtLink
              :to="
                $localePath({
                  name: 'faq-slug',
                  params: { slug: $t('slugs.ip-protection') }
                })
              "
            >
          ...
          <li>
            <NuxtLink
              :to="
                $localePath({
                  name: 'faq-slug',
                  params: { slug: $t('slugs.change-management') }
                })
              "
            >
          ...
          <li>
            <NuxtLink
              :to="
                $localePath({
                  name: 'faq-slug',
                  params: { slug: $t('slugs.custom-integration') }
                })
              "
            >
