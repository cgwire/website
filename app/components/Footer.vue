    ...
    <div class="columns">
      <div class="column">
        ...
        <ul>
          ...
          <li>
            <NuxtLink :to="$localePath('ftrack-alternative')">
              <span class="level-item"> Kitsu vs Ftrack </span>
            </NuxtLink>
          </li>
          <li>
            <NuxtLink :to="$localePath('faq-ip-protection')">
              <span class="level-item">IP Protection</span>
            </NuxtLink>
          </li>
          <li>
            <NuxtLink :to="$localePath('faq-migration')">
              <span class="level-item">Migration</span>
            </NuxtLink>
          </li>
          <li>
            <NuxtLink :to="$localePath('faq-change-management')">
              <span class="level-item">Change Management</span>
            </NuxtLink>
          </li>
          <li>
            <NuxtLink :to="$localePath('faq-custom-integration')">
              <span class="level-item">Custom Integration</span>
            </NuxtLink>
          </li>
          <li>
            <nuxt-link :to="$localePath('self-hosted')">
              <span class="level-item"> Cloud vs Self-Hosted </span>
            </nuxt-link>
          </li>
        </ul>
      </div>
      ...
      <div class="column">
        ...
        <ul>
          ...
          <li>
            <a href="https://github.com/cgwire">
              <span> Github </span>
            </a>
          </li>
        </ul>
      ...
      <div class="column">
        <p class="footer-title">
          {{ $t('footers title media') }}
        </p>
        <ul>
          <li>
            <a href="https://www.linkedin.com/company/cgwire/">
              <span> Linkedin </span>
            </a>
          </li>
          <li>
            <a href="https://twitter.com/cgwirekitsu">
              <span> Twitter </span>
            </a>
          </li>
          <li>
