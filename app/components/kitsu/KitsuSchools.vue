<template>
  ...
  <div data-aos="fade-up" class="best-supporter">
    ...
    <div class="successes">
      <NuxtPicture src="/images/kitsu/gobelins.png" format="webp" />
      <NuxtPicture src="/images/kitsu/rubika.png" format="webp" />
      <NuxtPicture src="/images/kitsu/melies.png" format="webp" />
    </div>
  </div>
