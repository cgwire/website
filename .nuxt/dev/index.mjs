...
import { eventHandler, setHeaders, sendRedirect, defineEventHandler, handleCacheHeaders, createEvent, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, lazyEventHandler, toNodeListener, getQuery, createError } from 'file:///home/frankrousseau/Projets/cg-wire/online/kitsu-cloud/node_modules/h3/dist/index.mjs';
...
import { parseURL, withQuery, joinURL } from 'file:///home/frankrousseau/Projets/cg-wire/online/kitsu-cloud/node_modules/ufo/dist/index.mjs';
...
import unstorage_47drivers_47fs from 'file:///home/frankrousseau/Projets/cg-wire/online/kitsu-cloud/node_modules/unstorage/dist/drivers/fs.mjs';
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","base":"/home/frankrousseau/Projets/cg-wire/online/kitsu-cloud","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","base":"/home/frankrousseau/Projets/cg-wire/online/kitsu-cloud/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","base":"/home/frankrousseau/Projets/cg-wire/online/kitsu-cloud/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","base":"/home/frankrousseau/Projets/cg-wire/online/kitsu-cloud/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const errorHandler = (async function errorhandler(error, event) {
  ...
  if (!res) {
    const { template } = await import('file:///home/frankrousseau/Projets/cg-wire/online/kitsu-cloud/node_modules/@nuxt/ui-templates/dist/templates/error-dev.mjs') ;
    {
