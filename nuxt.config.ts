...
export default defineNuxtConfig({
  ...
  routeRules: {
    "/features/casting-management": { prerender: true },
    "/features/elite-hosting": { prerender: true },
    "/features/production-tracker": { prerender: true },
    "/features/review-engine": { prerender: true },
    "/features/studio-database": { prerender: true },
    "/features/tailor-made-architecture": { prerender: true },
    "/features/team-collaboration": { prerender: true },
    "/features/top-notch-support": { prerender: true },
    "/shotgrid-alternative": { prerender: true },
    "/ftrack-alternative": { prerender: true },
    "/for-schools": { prerender: true },
    "/for-tvshows": { prerender: true },
    "/for-shorts": { prerender: true },
    "/for-video-games": { prerender: true },
    "/for-feature-films": { prerender: true },
  },
  css: [
    // "bulma",
