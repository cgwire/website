{
	...
	"main contact introduction": "Want to try CGWire suite? We offer 30 days trials!",
	...
	"zou explaination one": "Zou is an HTTP API that allows you to centralize all your data. Your CG tools can connect to it and query the data from your CG production. It helps your CG artists to manage their files and their tasks more efficiently and encourage them to spend more time focusing on the artistic side.",
	"zou tagline": "With Zou synchronize your production",
	"zou why one": "Building a movie is a tedious task that involves a lot of data: assets, shots, casting, task assignation, file locations and more. All this information must be shared among all the departements. Zou provides you with a central storage to store all this data.",
	"zou features one": "Store your production information and track your tasks progress.",
	"zou usecase one": "DCC plugins can easily be connected to Zou. This allows you to bring your production data inside your CG tools. And because it can be hosted in-house, it provides extra confidentiality, a faster response time and availability when the internet is down.",
	...
	"kitsu title": "With Kitsu manage your production without stress.",
	...
	"kitsu tagline": "With Kitsu manage your production without stress",
	...
	"gazu title": "With Gazu, boost your CG tools with your production data",
	"gazu explaination one": "With Gazu, it is super easy to query Zou. We wanted a Python client that is simple to understand and start with. Write your code like you would write plain text and enjoy adding value to your CG tools.",
	"gazu tagline": "With Gazu, boost your CG tools with your production data",
	"gazu why one": "We noticed that tools from major production and asset management solutions are complex to use. When dealing with the many data of CG production, it can lead to frustration and errors. Which is why we made a simple Python client. With it you can easily query the API and find the information you need.",
	"gazu features one": "Intuitive functions to fetch production data.",
	"gazu usecase one": "Displaying the CG artist tasks and files directly in his DCC solution has never been easier. Simply include the Gazu client to your app and lay back as your tools and plugins access your production data in a second.",
	...
	"zou features three": "Synchronize your data with Kitsu or Shotgun and manage validations.",
	...
	"pricing explaination one": "See all our pricing plans depending on your needs and your size",
	"pricing tagline": "Pricing plans for the CGWire suite including Kitsu, Zou and Gazu",
	...
	"pricing button cta": "Start your 30-days trial",
	"pricing notgoodidea": "Using CGWire for a big studio is not recommended. Ftrack, Shotgun or NIM are better suited for that.",
	"pricing discount details": "All plans come with 30 days trials and 10% discount for an annual subscription.",
	"pricing features free one": "1-5 users",
	"pricing features free two": "Unlimited projects",
	"pricing features free three": "200GB storage",
	"pricing features free four": "Forum support",
	"pricing features free five": "Access to support engineers",
	"pricing features basic one": "6 - 50 users",
	"pricing features basic two": "Unlimited projects",
	"pricing features basic three": "1TB of storage",
	"pricing features basic four": "Skype support",
	"pricing features basic five": "Access to support engineers",
	"pricing features medium one": "51 - 150 users",
	"pricing features medium two": "Unlimited projects",
	"pricing features medium three": "3TB of storage",
	"pricing features medium four": "Skype support",
	"pricing features medium five": "Access to support engineers",
